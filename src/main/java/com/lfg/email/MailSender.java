...
public class MailSender {
    ...
    public void send() {
        ...
        mailInfo.setNotifyTo("645765227@qq.com");
    ...
    public static void main(String[] args) throws MessagingException {
        ...
        // 此处填写你的账号
        props.put("mail.user", "645765227@qq.com");
        // 此处的密码就是前面说的16位STMP口令
        props.put("mail.password", "ibgwanmavpzrbbai");
        ...
        // 设置收件人的邮箱
        InternetAddress to = new InternetAddress("645765227@qq.com");
